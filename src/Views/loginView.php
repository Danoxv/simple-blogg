        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7 text-center">
                    <h1 class="mb-4 text-white">Login form</h1>
                    <p class="mb-4">Login or <a href='/registrpage.php'>register</a> for further actions </p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8 mb-5 " style="margin-left: 360px;">
                    <form action="/SignIn.php" method="post">
                        ...
                        <div class="container">
                            ...
                            <label for="uname"><p style=" position:relative;left:135px;">Username</p></label><br/>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input type="text" class="form-control" style=" position:relative;left:5px;"
